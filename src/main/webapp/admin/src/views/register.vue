<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于Java的校园拼车系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="紧急联系人" class="input" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="紧急电话" class="input" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="紧急联系人" class="input" v-if="tableName=='siji'">
			  <el-input v-model="ruleForm.jinjilianxiren" autocomplete="off" placeholder="紧急联系人"  />
			</el-form-item>
			<!-- <div v-if="tableName=='siji'" class="input-group">
			   <div class="label">紧急电话</div>
			...
			<el-form-item label="紧急电话" class="input" v-if="tableName=='siji'">
			  <el-input v-model="ruleForm.jinjidianhua" autocomplete="off" placeholder="紧急电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='siji'" class="input-group">
			   <div class="label">车型</div>
			   <div class="input-container">
			     <input v-model="ruleForm.chexing" class="input" type="text" placeholder="车型">
			   </div>
			 </div> -->
			<el-form-item label="车型" class="input" v-if="tableName=='siji'">
			  <el-input v-model="ruleForm.chexing" autocomplete="off" placeholder="车型"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`xuesheng` == this.tableName && this.ruleForm.jinjidianhua&&(!this.$validate.isMobile(this.ruleForm.jinjidianhua))){
      ...
      if(`siji` == this.tableName && this.ruleForm.jinjidianhua&&(!this.$validate.isMobile(this.ruleForm.jinjidianhua))){
        this.$message.error(`紧急电话应输入手机格式`);
        return
      }
      this.$http({
