<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiashizheng" label="驾驶证" prop="jiashizheng">
          <file-upload
          tip="点击上传驾驶证"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiashizheng" label="驾驶证" prop="jiashizheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiashizheng.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
