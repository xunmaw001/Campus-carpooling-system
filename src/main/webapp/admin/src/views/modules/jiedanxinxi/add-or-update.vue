  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="接单状态" prop="jiedanzhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单备注" prop="jiedanbeizhu">
          <el-input v-model="ruleForm.jiedanbeizhu" 
              placeholder="接单备注" clearable  :readonly="ro.jiedanbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单备注" prop="jiedanbeizhu">
              <el-input v-model="ruleForm.jiedanbeizhu" 
                placeholder="接单备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiedanzhuangtai = true;
          ...
          if(o=='jiedanbeizhu'){
            this.ruleForm.jiedanbeizhu = obj[o];
	    this.ro.jiedanbeizhu = true;
            continue;
          }
          if(o=='xuehao'){
      ...
      this.$http({
		...
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.jiedanzhuangtaiOptions = "待付款,已完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
